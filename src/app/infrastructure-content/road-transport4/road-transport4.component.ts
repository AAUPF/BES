...
@Component({
  selector: 'app-road-transport4',
  templateUrl: './road-transport4.component.html',
  styleUrls: ['./road-transport4.component.css']
})
export class RoadTransport4Component implements OnInit {
  ...
  years = [2016, 2017];
  views = ViewsNotTrend
  rain_fall_type = [{key: "All", value: "All"},{key:"Truck",value:"Truck"},	{key:"Bus",value:"Bus"},	{key:"Car",value:"Car"},	{key:"Taxi",value:"Taxi"},{key:"Jeep",value:"Jeep"},{key:"Three Wheeler",value:"Three_Wheeler"},{key:"Two Wheeler",value:"Two_Wheeler"},{key:"Tractor",value:"Tractor"},{key:"Trailor",value:"Trailor"},{key:"Other",value:"Other"}]
