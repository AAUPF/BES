...
@Component({
  selector: 'app-road-transport3',
  templateUrl: './road-transport3.component.html',
  styleUrls: ['./road-transport3.component.css']
})
export class RoadTransport3Component implements OnInit {
  ...
  Comparison = [
    {key:"None",value:"None"},
    {key:"Revenue Collection ",value:"Revenue Collection "},
    {key:"No. of Passengers Carried",value:"No. of Passengers Carried"},
  ]
