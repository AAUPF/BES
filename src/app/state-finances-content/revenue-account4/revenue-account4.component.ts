...
@Component({
  selector: 'app-revenue-account4',
  templateUrl: './revenue-account4.component.html',
  styleUrls: ['./revenue-account4.component.css']
})
export class RevenueAccount4Component implements OnInit {
