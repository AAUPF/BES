...
export class RevenueAccount2Component implements OnInit {
  ...
  Comparison = ["None","Non Developmental Expenditure","Developmental Expenditure","Total Expenditure"]
    data: any = {};    
    toNumber(d) {
      if (d == "All" ||  d === "Development Expenditure as percentage of Total Expenditure") {
        this.data.Comparison = "None"
        this.Comparison = ["None"]
      }
      else {
        this.Comparison = ["None","Non Developmental Expenditure","Developmental Expenditure","Total Expenditure"]
      }
    }
