...
@Component({
  selector: 'app-resource-management2',
  templateUrl: './resource-management2.component.html',
  styleUrls: ['./resource-management2.component.css']
})
export class ResourceManagement2Component implements OnInit {
  ...
  Comparison = ["None","Taxes on Sales, Trade etc.","Taxes on Goods and Passengers","State Excise","Stamp and Registration Fees","Taxes on Vehicles","Land Revenue","Taxes and Duties on Electricity","Other Taxes/ Duties on Comm. and Services","Other taxes on Income and Expenditure"]
    ...
    toNumber(d) {
      if (d == "All") {
        ...
        this.Comparison = ["None","Taxes on Sales, Trade etc.","Taxes on Goods and Passengers","State Excise","Stamp and Registration Fees","Taxes on Vehicles","Land Revenue","Taxes and Duties on Electricity","Other Taxes/ Duties on Comm. and Services","Other taxes on Income and Expenditure"]
      }
  ...
  onSubmit(user) {
    var controller = "resource_management2s"
