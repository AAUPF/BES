...
export class DeficitManagement3Component implements OnInit {
  ...
  visbile_chart= true;
  visbile_table= false;
  Districts = ["All","Revenue Deficit","Capital Outlay","Net Lending","GFD","GSDP","GFD: GSDP ratio (%)"]
  years = [2012,2013,2014,2015,2016,2017];
  views = ViewsNotMap
  rain_fall_type = [{key:"Amount",value:"Amount"}]
  rain_fall_type_sort = this.rain_fall_type.sort(f.compare);
    Comparison = ["None","Revenue Deficit","Capital Outlay","Net Lending","GFD","GSDP","GFD: GSDP ratio (%)"]
    ...
    if (d == "All") {
      ...
      this.Comparison = ["None","Revenue Deficit","Capital Outlay","Net Lending","GFD","GSDP","GFD: GSDP ratio (%)"]
