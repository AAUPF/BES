...
export class SectoralExpenditureComponent implements OnInit {
  ...
  Comparison = [
    ...
    toSet(select){
      ...
      else if(select == "Education, Sports, Arts & Culture") { 
        this.data.rain_fall_type  = undefined
      ...
      else if(select == "Health and Family Welfare") { 
        this.data.rain_fall_type  = undefined
      ...
      else if(select == "Water Supply, Sanitation, Housing and Urban Development") { 
        this.data.rain_fall_type  = undefined
      ...
      else if(select == "Total (Social Services)") { 
        this.data.rain_fall_type  = undefined
