...
@Component({
  selector: 'app-resource-management4',
  templateUrl: './resource-management4.component.html',
  styleUrls: ['./resource-management4.component.css']
})
export class ResourceManagement4Component implements OnInit {
    ...
    toNumber(d) {
      ...
      toView(view){
        if (view == "line") {
          ...
          this.years = ["All","2013-14","2014-15","2015-16","2016-17","2017-18_BE","CAGR_2012_to_18"];
        }
      }
      toYear(year){
        if(year == "All"){
  ...
  onSubmit(user) {
    var controller = "resource_management4s"
    user.rain_fall_type = "Percentage_Growth_Over_Previous_Year"
