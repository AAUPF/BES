...
@Component({
  selector: 'app-resource-management8',
  templateUrl: './resource-management8.component.html',
  styleUrls: ['./resource-management8.component.css']
})
export class ResourceManagement8Component implements OnInit {
  ...
  years = ["All","2012-13","2013-14","2014-15","2015-16","2016-17","2017-18","CAGR_2012_to_18"];
  views = ViewsNotMap
  rain_fall_type = [{key:"Yearly Growth Rates",value:"Yearly_Growth_Rates"}]
    ...
    toNumber(d) {
      ...
      toView(view){
        if (view == "line") {
          ...
          this.years = ["All","2012-13","2013-14","2014-15","2015-16","2016-17","2017-18","CAGR_2012_to_18"];
        }
      }
      toYear(year){
        if(year == "All"){
  ...
  onSubmit(user) {
    var controller = "resource_management8s"
    user.rain_fall_type = "Yearly_Growth_Rates"
