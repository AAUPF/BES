...
@Component({
  selector: 'app-sectoral-expenditure1',
  templateUrl: './sectoral-expenditure1.component.html',
  styleUrls: ['./sectoral-expenditure1.component.css']
})
export class SectoralExpenditure1Component implements OnInit {
  ...
  Comparison = [
    ...
    onSubmit(user) {
    var controller = "sectoral_expenditure1s"
