...
@Component({
  selector: 'app-agricultural-inputs3',
  templateUrl: './agricultural-inputs3.component.html',
  styleUrls: ['./agricultural-inputs3.component.css']
})
export class AgriculturalInputs3Component implements OnInit {
