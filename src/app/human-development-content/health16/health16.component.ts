...
@Component({
  selector: 'app-health16',
  templateUrl: './health16.component.html',
  styleUrls: ['./health16.component.css']
})
export class Health16Component implements OnInit {
