...
@Component({
  selector: 'app-district-wise-section10',
  templateUrl: './district-wise-section10.component.html',
  styleUrls: ['./district-wise-section10.component.css']
})
export class DistrictWiseSection10Component implements OnInit {
  ...
  visbile_chart= true;
  visbile_table= false;
Districts = ["Financial Allotment","Physical Achievement"]
  years = [
    "All",
    "2012-13",
    "2013-14",
  ...
  views = ViewsNotMap;
  Comparison = [
    {key:"Stipend given to SC and ST",value:"Stipend given to SC and ST"},
  ]
  rain_fall_type = [
    {key:"All",value:"All"},
  ...
  onSubmit(user) {
    var controller = "district_wise_section10s"
