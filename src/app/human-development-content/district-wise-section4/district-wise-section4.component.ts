...
@Component({
  selector: 'app-district-wise-section4',
  templateUrl: './district-wise-section4.component.html',
  styleUrls: ['./district-wise-section4.component.css']
})
export class DistrictWiseSection4Component implements OnInit {
