...
@Component({
  selector: 'app-district-wise-section9',
  templateUrl: './district-wise-section9.component.html',
  styleUrls: ['./district-wise-section9.component.css']
})
export class DistrictWiseSection9Component implements OnInit {
