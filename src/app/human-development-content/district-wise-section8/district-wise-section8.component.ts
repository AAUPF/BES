...
@Component({
  selector: 'app-district-wise-section8',
  templateUrl: './district-wise-section8.component.html',
  styleUrls: ['./district-wise-section8.component.css']
})
export class DistrictWiseSection8Component implements OnInit {
  ...
  views = ViewsNotMap;
  rain_fall_type = [{key:"All",value:"All"},{key:"Affiliated College",value:"Affiliated_College"},
...
if (view == "line") {
  ...
  onSubmit(user) {
    var controller = "district_wise_section8s"
