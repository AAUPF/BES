...
@Component({
  selector: 'app-health12',
  templateUrl: './health12.component.html',
  styleUrls: ['./health12.component.css']
})
export class Health12Component implements OnInit {
  ...
  visbile_chart= true;
  visbile_table= false;
  Districts = ["All","NRHM-A","NRHM-B","NRHM-C","NRHM-D","NRHM-E","NRHM-F","NRHM-G","Total"]
  years = [2011,2012,2013,2014,2015,2016];
  views = ViewsNotMap;
  rain_fall_type = [{key:"Fund Disbursed",value:"Fund_Disbursed"}]
  rain_fall_type_sort = this.rain_fall_type.sort(f.compare);
    Comparison = ["None","NRHM-A","NRHM-B","NRHM-C","NRHM-D","NRHM-E","NRHM-F","NRHM-G","Total"]
    data: any = {};
    toNumber(d) {
    if (d == "All") {
