...
@Component({
  selector: 'app-health4',
  templateUrl: './health4.component.html',
  styleUrls: ['./health4.component.css']
})
export class Health4Component implements OnInit {
  ...
  rain_fall_type = [{key: "All", value: "All"}, {key: "Number of patients visiting government hospitals per month", value: "Number_of_patients_visiting_government_hospitals_per_month"},{key:"Percentage growth",value:"Percentage_growth"}]
  rain_fall_type_sort = this.rain_fall_type.sort(f.compare);
  Comparison = [{key: "None", value: "None"}, {key: "Number of patients visiting government hospitals per month", value: "Number_of_patients_visiting_government_hospitals_per_month"},{key:"Percentage growth",value:"Percentage_growth"}]
