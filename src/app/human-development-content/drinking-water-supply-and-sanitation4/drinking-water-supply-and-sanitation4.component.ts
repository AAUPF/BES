...
@Component({
  selector: 'app-drinking-water-supply-and-sanitation4',
  templateUrl: './drinking-water-supply-and-sanitation4.component.html',
  styleUrls: ['./drinking-water-supply-and-sanitation4.component.css']
})
export class DrinkingWaterSupplyAndSanitation4Component implements OnInit {
  ...
  visbile_chart= true;
  visbile_table= false;
  Districts = ["All","Rural Piped Water Supply Scheme",
  "Installation of New instead of Old Hand Pumps",
  "Uncovered Tolas",]
  ...
  Comparison  = ["None","Rural Piped Water Supply Scheme",
  "Installation of New instead of Old Hand Pumps",
  "Uncovered Tolas",]
  ...
  if (this.data.rain_fall_type == "All") {
    ...
    toSet(select){
      if (select == "All") {
        ...
        this.Comparison  = ["None","Rural Piped Water Supply Scheme",
        "Installation of New instead of Old Hand Pumps",
        "Uncovered Tolas",]
