...
@Component({
  selector: 'app-health11',
  templateUrl: './health11.component.html',
  styleUrls: ['./health11.component.css']
})
export class Health11Component implements OnInit {
  ...
  rain_fall_type_sort = this.rain_fall_type.sort(f.compare);
    Comparison = ["None","Acute Diarrhoea","Bacillary Dysentery","Viral Hepatitis","Enteric Fever","Malaria","Fever of Unknown Origin","Acute Respiratory Illnesses","Pneumonia","Dog Bite","Any other State Specific disease","Unusual Syndromes not captured above","Total"]
    data: any = {};
    toNumber(d) {
    if (d == "All") {
