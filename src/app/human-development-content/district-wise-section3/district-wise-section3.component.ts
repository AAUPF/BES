...
@Component({
  selector: 'app-district-wise-section3',
  templateUrl: './district-wise-section3.component.html',
  styleUrls: ['./district-wise-section3.component.css']
})
export class DistrictWiseSection3Component implements OnInit {
...
if (view == "line") {
  ...
  onSubmit(user) {
    var controller = "district_wise_section3s"
