...
@Component({
  selector: 'app-social-welfare3',
  templateUrl: './social-welfare3.component.html',
  styleUrls: ['./social-welfare3.component.css']
})
export class SocialWelfare3Component implements OnInit {
  ...
  htmlContent:string;
  Districts = ["Stipend for students of primary, middle and high school","Post-Matric Scholarship","OBC Girls’ Higher Secondary Residential School (12 nos.)","Mukhyamantri Medhavriti Yojana for EBC students","Stipend for students in technical courses","Construction of 38 Jannayak Karpuri Thakur Hostels for EBC Students"];
  visbile= false;
  visbile_chart= true;
  visbile_table= false;
  ...
  Comparison_sort = this.Comparison.sort(f.compare);
    ...
    "2016-17",
      ...
      onSubmit(user) {
        var controller = "social_welfare3s"
