...
@Component({
  selector: 'app-production-productivity8',
  templateUrl: './production-productivity8.component.html',
  styleUrls: ['./production-productivity8.component.css']
})
export class ProductionProductivity8Component implements OnInit {
  ...
  onSubmit(user) {
    var controller = "production_productivity8s"
    if (user.view == "Graph") {
