...
@Component({
  selector: 'app-agricultural-inputs1',
  templateUrl: './agricultural-inputs1.component.html',
  styleUrls: ['./agricultural-inputs1.component.css']
})
export class AgriculturalInputs1Component implements OnInit {
