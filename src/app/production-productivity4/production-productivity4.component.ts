...
@Component({
  selector: 'app-production-productivity4',
  templateUrl: './production-productivity4.component.html',
  styleUrls: ['./production-productivity4.component.css']
})
export class ProductionProductivity4Component implements OnInit {
