...
@Component({
  selector: 'app-production-productivity13',
  templateUrl: './production-productivity13.component.html',
  styleUrls: ['./production-productivity13.component.css']
})
export class ProductionProductivity13Component implements OnInit {
