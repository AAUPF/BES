...
@Component({
  selector: 'app-production-productivity5',
  templateUrl: './production-productivity5.component.html',
  styleUrls: ['./production-productivity5.component.css']
})
export class ProductionProductivity5Component implements OnInit {
