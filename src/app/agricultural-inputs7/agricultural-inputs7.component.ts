...
@Component({
  selector: 'app-agricultural-inputs7',
  templateUrl: './agricultural-inputs7.component.html',
  styleUrls: ['./agricultural-inputs7.component.css']
})
export class AgriculturalInputs7Component implements OnInit {
