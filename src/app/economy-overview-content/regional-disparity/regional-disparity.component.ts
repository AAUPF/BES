...
@Component({
  selector: 'app-regional-disparity',
  templateUrl: './regional-disparity.component.html',
  styleUrls: ['./regional-disparity.component.css']
})
export class RegionalDisparityComponent implements OnInit {
  ...
  visbile_chart= true;
  visbile_table= false;
  Districts = ["All","GDDP","Petrol Consumption","Diesel Consumption","LPG Consumption","Small Savings"]
  //  years = [2016, 2017];
  // views =[{key: "Table", value: "Table"}];
  rain_fall_type = [{key: "All", value: "All"},{key:"Top 3 District",value:"Top_3_District"},	{key:"Bottom 3 District",value:"Bottom_3_District"}]
