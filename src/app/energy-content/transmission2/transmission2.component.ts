...
@Component({
  selector: 'app-transmission2',
  templateUrl: './transmission2.component.html',
  styleUrls: ['./transmission2.component.css']
})
export class Transmission2Component implements OnInit {
  ...
  rain_fall_type = [{key: "All", value: "All"},{key:"Nos of New Grid Sub Stations",value:"Nos_of_New_Grid_Sub_Stations"},
  {key:"New Transmission Lines Circuit km",value:"New_Transmission_Lines_Circuit_km"},]
