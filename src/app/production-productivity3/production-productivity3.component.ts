...
@Component({
  selector: 'app-production-productivity3',
  templateUrl: './production-productivity3.component.html',
  styleUrls: ['./production-productivity3.component.css']
})
export class ProductionProductivity3Component implements OnInit {
