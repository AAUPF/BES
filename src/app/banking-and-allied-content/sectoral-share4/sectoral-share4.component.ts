...
@Component({
  selector: 'app-sectoral-share4',
  templateUrl: './sectoral-share4.component.html',
  styleUrls: ['./sectoral-share4.component.css']
})
export class SectoralShare4Component implements OnInit {
  ...
  htmlContent:string;
  Districts = ["Commercial Bank","RRBs","CCBs","Total"];
  visbile= false;
  visbile_chart= true;
  visbile_table= false;
  ...
  Comparison_sort = this.Comparison.sort(f.compare);
    ...
    "2016-17",
      ...
      onSubmit(user) {
        var controller = "sectoral_share4s"
