...
@Component({
  selector: 'app-sectoral-share9',
  templateUrl: './sectoral-share9.component.html',
  styleUrls: ['./sectoral-share9.component.css']
})
export class SectoralShare9Component implements OnInit {
  ...
  htmlContent:string;
  Districts = ["Commercial Banks","RRBs","CCB","Total"];
  visbile= false;
  visbile_chart= true;
  visbile_table= false;
  ...
  Comparison = [{key: "None", value: "None"}, {key:"Target",value:"Target"},
  {key:"Achievement",value:"Achievement"},
  {key:"Achievement Percentage",value:"Achievement_Percentage"}	]
  Comparison_sort = this.Comparison.sort(f.compare);
    ...
    "2016-17",
      ...
      onSubmit(user) {
        var controller = "sectoral_share9s"
