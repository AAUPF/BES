...
@Component({
  selector: 'app-level-of-urbanisation1',
  templateUrl: './level-of-urbanisation1.component.html',
  styleUrls: ['./level-of-urbanisation1.component.css']
})
export class LevelOfUrbanisation1Component implements OnInit {
  ...
  htmlContent:string;
  Districts = ["Level of Urbanisation","Urban Population"];
  visbile= false;
  visbile_chart= true;
  visbile_table= false;
  ...
  views = ViewsNotMap;
  rain_fall_type = [{key: "All", value: "All"}, {key:"India",value:"India"},
  {key:"Bihar",value:"Bihar"}	]
  rain_fall_type_sort = this.rain_fall_type.sort(f.compare);
  Comparison = [{key: "None", value: "None"}, {key:"India",value:"India"},
  {key:"Bihar",value:"Bihar"}	]
