...
export class UDPJointlyFunded1Component implements OnInit {
  ...
  visbile_chart= true;
  visbile_table= false;
  Districts = ["All","Ganga River Front Development (GRFD) Patna","Saidpur Sewer network for Patna","Saidpur STP and Adjoining Network for Patna","Karmalichak Sewerage Scheme for Patna","Sewerage & Sewage Treatment Plant at Begusarai*","Sewerage & Sewage Treatment Plant at Buxar","Sewerage & Sewage Treatment Plant at Hajipur*","Sewerage & Sewage Treatment Plant at Munger*","Sewerage Treatment Plant, Karmalichak (Patna)","Sewerage Treatment Plant, Beur (Patna)","Sewerage scheme Pahari Zone V \"for Patna","Sewerage System in Sewerage Zone IV A (South) Pahari","Sewage Treatment Plant (60 MLD), Pahari for Patna","Beur sewerage Network for Patna in Bihar","Mokama Sewerage Project","Barh  Sewerage Project","Navgachiya Sewerage Project","Sultanganj Sewerage Project","Bhagalpur Sewerage Project","Digha Sewerage Project","Kankarbagh Sewerage Project","Total"]
