...
@Component({
  selector: 'app-udp-jointly-funded5',
  templateUrl: './udp-jointly-funded5.component.html',
  styleUrls: ['./udp-jointly-funded5.component.css']
})
export class UDPJointlyFunded5Component implements OnInit {
  ...
  rain_fall_type = [{key: "All", value: "All"},{key:"Annual Target",value:"Annual_Target"},	{key:"Progress",value:"Progress"}]
  rain_fall_type_sort = this.rain_fall_type.sort(f.compare);
    Comparison = ["None", "No. of Cities to be covered for Street vendor Survey",
    "No. of Cities in which vendor survey started",
    "No. of Cities completed vendor survey",
    "No. of Street vendors identified in surveyed cities (Bio-metric survey)",
    "No. of Street vendors issued ID cards",
