...
@Component({
  selector: 'app-production-productivity9',
  templateUrl: './production-productivity9.component.html',
  styleUrls: ['./production-productivity9.component.css']
})
export class ProductionProductivity9Component implements OnInit {
